import { isArray, isString, isNumber, isNotEmptyArray } from './base.mjs';
 ...
 * 取出节点数据
 */
const takeTreeByKey = (trees, key, value = 'value', children = 'children') => {
 ...
 * 取出节点文本
 */
const takeLabelByKey = (trees, key, label = 'label', value = 'value', children = 'children') => {
 ...
 * 根据格式转换 时间
 */
const takeTimeToFormat = (date, format = 'YYYY-MM-DD HH:mm:ss') => {
    if (date) {
        try {
...
export { helper as default, takeFixed, takeLabelByKey, takePadEnd, takeTimeToDate, takeTimeToFormat, takeTreeByKey };
